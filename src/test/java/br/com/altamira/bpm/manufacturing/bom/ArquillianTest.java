package br.com.altamira.bpm.manufacturing.bom;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "bpm-manufacturing-bom";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "bpm-manufacturing-bom.war")
            ...
            .addPackages(false, "br.com.altamira.bpm.manufacturing.bom") // not recursive to skip package 'nonarquillian'
